...
{
    public class AddEventsForCandidateHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public AddEventsForCandidateHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CandidateActivities.xml");
        }
