...
{
    public class AdminTaggableLeadModulesHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public AdminTaggableLeadModulesHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("AdminTaggableLeadModules.xml");
        }
