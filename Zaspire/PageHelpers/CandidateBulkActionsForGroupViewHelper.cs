...
{
    public class CandidatesBulkActionsForGroupViewHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CandidatesBulkActionsForGroupViewHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CandidateBulkActionsForGroupView.xml");
        }
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("html/body/div[4]/div[2]/div[2]/div[1]/div/div[2]/form/div/div[5]/div/div[1]/div/div[3]/div/button"));
