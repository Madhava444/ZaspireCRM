...
{
    public class CandidateCustomViewActionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CandidateCustomViewActionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CandidateCustomViewActions.xml");
        }
