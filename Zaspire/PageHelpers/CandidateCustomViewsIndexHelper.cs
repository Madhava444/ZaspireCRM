...
{
    public class CandidateCustomViewsIndexHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CandidateCustomViewsIndexHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CandidateCustomViewsIndex.xml");
        }
