...
{
    public class CandidateGroupAddNewPageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CandidateGroupAddNewPageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CandidateGroupAddNewPage.xml");
        }
        ...
        internal static void Ty(string p)
        {
