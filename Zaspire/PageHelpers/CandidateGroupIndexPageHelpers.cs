...
{
    public class CandidateGroupIndexPageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CandidateGroupIndexPageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CandidateGroupIndexPage.xml");
        }
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='candidate_groups_wrapper']/div[1]/div/div/button"));
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='candidate_groups']/tbody/tr[1]/td[2]/a"));
