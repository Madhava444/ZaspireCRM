...
{
    public class CandidateGroupTrashIndexHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CandidateGroupTrashIndexHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CandidateGroupTrashIndex.xml");
        }
