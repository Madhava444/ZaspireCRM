...
{
    public class CandidateGroupUpdateHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CandidateGroupUpdateHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CandidateGroupUpdate .xml");
        }
