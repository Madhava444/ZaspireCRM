...
{
    public class CandidateGroupViewHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CandidateGroupViewHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CandidateGroupView.xml");
        }
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("html/body/div[4]/div[2]/div[3]/div[1]/div/div[2]/form/div/div[4]/div/div[1]/div/div[3]/div/button"));
