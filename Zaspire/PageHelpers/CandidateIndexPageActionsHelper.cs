...
{
    public class CandidateIndexPageActionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CandidateIndexPageActionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("Candidate.xml");
        }
