...
{
    public class CandidateBulkActionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CandidateBulkActionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CandidateBulkActions.xml");
        }
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='candidates_grid_wrapper']/div[1]/div/div/button"));
