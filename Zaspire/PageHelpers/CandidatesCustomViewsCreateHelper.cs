...
{
    public class CandidateCustomViewsCreateHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CandidateCustomViewsCreateHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CandidateCustomViewsCreate.xml");
        }
