...
namespace Zaspire.PageHelpers.Comm
{
    public class AddContactHelper : DriverHelper
    {
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("html/body/div[4]/div[2]/div[2]/div/div/div[2]/div/div[2]/div[1]/div[1]/div[2]/div/a"));
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='activities_table']/tbody/tr[2]/td[2]"));

            var builder = new Actions(GetWebDriver());
            builder.MoveToElement(el).Build().Perform();
        }

        public void MouseOver3(string locator)
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='activities_table']/tbody/tr[2]/td[2]"));
        ...
        public void MouseOver4(string locator)
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='activities_table']/tbody/tr[3]/td[2]"));
