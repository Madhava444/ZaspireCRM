...
namespace Zaspire.PageHelpers.Commmmm
{
   
    public class ContactBulkUpdateHelper: DriverHelper
    {
        public LocatorReader locatorReader;

        public ContactBulkUpdateHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("ContactBulkupdate.xml");
        }
        ...
        public void MouseHover22(string locator)
        { 
