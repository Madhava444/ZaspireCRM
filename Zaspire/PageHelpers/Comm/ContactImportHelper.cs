...
{
    public class ContactImportHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public ContactImportHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("ContactImport.xml");
        }
        ...
        public void MouseOver17(string locator)
        {
            var el = GetWebDriver().FindElement(ByLocator("html/body/div[4]/div[2]/div[1]/div/ul/li[6]/div/button"));
