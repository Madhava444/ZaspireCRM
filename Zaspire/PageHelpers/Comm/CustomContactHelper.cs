...
{
    public class CustomContactHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CustomContactHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("ContactCustom.xml");
        }
        ...
        public void MouseHover20(string locator)
        {
