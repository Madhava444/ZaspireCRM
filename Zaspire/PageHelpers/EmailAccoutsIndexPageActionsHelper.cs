...
{
    public class EmailAcccountsIndexPageActionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public EmailAcccountsIndexPageActionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("EmailAccountsIndexpage.xml");
        }
