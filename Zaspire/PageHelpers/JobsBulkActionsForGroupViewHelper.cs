...
{
    public class JobsBulkActionsForGroupViewHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public JobsBulkActionsForGroupViewHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("JobsBulkActionsForGroupView.xml");
        }
