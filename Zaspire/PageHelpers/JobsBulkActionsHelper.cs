...
{
    public class JobsBulkActionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public JobsBulkActionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("JobsBulkActions.xml");
        }
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='jobs_grid_wrapper']/div[1]/div/div/button"));
