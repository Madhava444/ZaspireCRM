...
{
    public class JobsCustomViewActionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public JobsCustomViewActionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("JobsCustomViewActions.xml");
        }
