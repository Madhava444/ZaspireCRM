...
{
    public class JobsCustomViewsCreateHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public JobsCustomViewsCreateHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("JobsCustomViewsCreate.xml");
        }
