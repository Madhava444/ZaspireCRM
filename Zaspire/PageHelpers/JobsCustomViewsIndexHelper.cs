...
{
    public class JobsCustomViewsIndexHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public JobsCustomViewsIndexHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("JobsCustomViewsIndex.xml");
        }
