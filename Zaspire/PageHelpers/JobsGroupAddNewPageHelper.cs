...
{
    public class JobsGroupAddNewPageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public JobsGroupAddNewPageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("JobsGroupAddNewPage.xml");
        }
