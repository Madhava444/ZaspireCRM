...
{
    public class JobsGroupIndexPageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public JobsGroupIndexPageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("JobsGroupIndexPage.xml");
        }
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='job_groups_wrapper']/div[1]/div/div/button"));
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='job_groups']/tbody/tr[1]/td[2]/a"));
