...
{
    public class JobsImportsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public JobsImportsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("JobsImports.xml");
        }
        ...
        public void upload1(string locator)
        {
            ...
            IWebElement element = GetWebDriver().FindElement(ByLocator("//*[@id='JobCsvFile']"));
            element.SendKeys("C:\\Users\\ISS_LP04\\Desktop\\dataFeb-2-2016.csv");
        }
