...
{
    public class JobsTrashIndexPageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public JobsTrashIndexPageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("Jobs.xml");
        }
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='job_trash_wrapper']/div[1]/div/div/button"));
