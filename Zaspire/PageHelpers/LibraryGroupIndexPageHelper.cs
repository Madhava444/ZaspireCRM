...
{
    public class LibrariesGroupIndexPageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public LibrariesGroupIndexPageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("LibraryGroup.xml");
        }
        ...
        public void DudlicateClick()
        {
            ...
            var Save = "//*[@id='LibraryCreateForm']/div[2]/div/ul/li[5]/button";
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='library_groups_wrapper']/div[1]/div/div/button"));
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='library_groups']/tbody/tr[1]/td[2]/a"));
