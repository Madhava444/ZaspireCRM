...
{
    [TestClass]
 public class MoreActionsMeetings : DriverTestCase
        {
            [TestMethod]
            public void moreactionsmeetings()
            {
                ...
                AccountsMoreActionsHelper.ClickElement("Meetings");

                AccountsMoreActionsHelper.TypeText("Location", "Ohio");

                AccountsMoreActionsHelper.TypeText("EnterSubject", "New Meeting");
