...
{
    [TestClass]
    public class View_Page_Contacts_Info : DriverTestCase
    {
        [TestMethod]
        public void ViewpageContactsInfo()
        {
            ...
            AddAccountHelper.ClickElement("ClickContactsInfo");
            AddAccountHelper.WaitForWorkAround(1000);

            //AddAccountHelper.Click("ClickOnEmailLink");
