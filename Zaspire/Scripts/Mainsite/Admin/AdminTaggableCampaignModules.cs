...
{
    [TestClass]
    public class AdminTaggableCampaignModules : DriverTestCase
    {
        [TestMethod]
        public void admintaggableCampaignmodules()
        {
            ...
            AdminTaggableLeadModulesHelpher.Select("selectmodule", "20");
            AdminTaggableLeadModulesHelpher.ClickElement("CGroup");
            AdminTaggableLeadModulesHelpher.ClickElement("CName");
            AdminTaggableLeadModulesHelpher.ClickElement("CCategory");
