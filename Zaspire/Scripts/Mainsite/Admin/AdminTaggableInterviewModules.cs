...
{
    [TestClass]
    public class AdminTaggableInterviewModules : DriverTestCase
    {
        [TestMethod]
        public void admintaggableInterviewmodules()
        {
            ...
            AdminTaggableLeadModulesHelpher.Select("selectmodule", "16");
            AdminTaggableLeadModulesHelpher.ClickElement("IZipCode");
            AdminTaggableLeadModulesHelpher.ClickElement("IAddressLine");
            AdminTaggableLeadModulesHelpher.ClickElement("ICity");
            AdminTaggableLeadModulesHelpher.ClickElement("IState");
            AdminTaggableLeadModulesHelpher.ClickElement("ICountry");
            AdminTaggableLeadModulesHelpher.ClickElement("IJobTitle");
            AdminTaggableLeadModulesHelpher.ClickElement("IReferenceCode");
            AdminTaggableLeadModulesHelpher.ClickElement("ICompany");
