...
{
    [TestClass]
    public class CandidateBulkAddToGroup : DriverTestCase
    {
        [TestMethod]
        public void Candidatebulkaddtogroup()
        {
            ...
            AddNewcandidateHelper.TypeText("RName", "Williams");

            //Enter Contact Phone Number
            AddNewcandidateHelper.TypeText("RDesignation", "Manager");

            //Enter Contact Phone Number
            AddNewcandidateHelper.TypeText("RCampanyname", "Polaris");
...
//###################  LEADS ADD TO CAMPAIGN   #########################
            ...
            //Click on Bulk Update
            CandidateBulkActionsHelper.ClickElement("ClickOnAddToGroup");
            CandidateBulkActionsHelper.WaitForWorkAround(4000);

            //Create New group
            CandidateBulkActionsHelper.TypeText("AddGroup", Groupname);

            
            //Select Lead Group
            //CandidateBulkActionsHelper.Select("SelectGroup", "10");

            //Enter Add New Lead Group Name
            //CandidateBulkActionsHelper.TypeText("SelectGroup", "Test Group");

            //Click On Add Leads
            CandidateBulkActionsHelper.ClickElement("ClickOnUpdategroup");
