...
{
    [TestClass]
    public class CandidateBulkEmail : DriverTestCase
    {
        [TestMethod]
        public void Candidatebulkemail()
        {
            ...
            AddNewcandidateHelper.TypeText("Skillname", "Java");
            ...
            AddNewcandidateHelper.TypeText("RName", "RichardCambell");

            //Enter Contact Phone Number
            AddNewcandidateHelper.TypeText("RDesignation", "Newworkadmin");

            //Enter Contact Phone Number
            AddNewcandidateHelper.TypeText("RCampanyname", "Dell");
...
//###################  LEADS BULK EMAIL   #########################
            ...
            CandidateBulkActionsHelper.TypeText("SearchCandidateCompany", "Test Title");
            ...
            //Click on Bulk Email
            CandidateBulkActionsHelper.ClickElement("ClickOnBulkEmail");
            CandidateBulkActionsHelper.WaitForWorkAround(4000);

            //Enter Email Cc Address
            CandidateBulkActionsHelper.TypeText("EnterEmailCcAddress", "");

            //Enter Email Bcc Address
            CandidateBulkActionsHelper.TypeText("EnterEmailBccAddress", "");

            //Enter Email Subject
            CandidateBulkActionsHelper.TypeText("EnterEmailSubject", "Test Email123");

            //Click On Prioroty
            CandidateBulkActionsHelper.ClickElement("ClickOnPriority");

            //Click On Copy To CC Check Box
            CandidateBulkActionsHelper.ClickElement("ClickOnCopyToCCCheckBox");

            //Select Copy To CC
            CandidateBulkActionsHelper.Select("SelectCopyToCC", "owners");

            //Click On Copy To BCC Check Box
            CandidateBulkActionsHelper.ClickElement("ClickOnCopyToBCCCheckBox");

            //Select Copy To BCC
            CandidateBulkActionsHelper.Select("SelectCopyToBCC", "Managers");

            //Select Email Signature
            //CandidateBulkActionsHelper.Select("SelectEmailSignature", "");

            //Click On Send Button
            CandidateBulkActionsHelper.ClickElement("ClickOnSendButton");
            CandidateBulkActionsHelper.WaitForWorkAround(10000);
