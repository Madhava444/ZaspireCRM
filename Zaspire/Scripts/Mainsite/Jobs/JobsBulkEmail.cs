...
{
    [TestClass]
    public class JobsBulkemail : DriverTestCase
    {
        [TestMethod]
        public void jobsBulkemail()
        {
            ...
            //Click on Bulk Email
            JobsBulkActionsHelper.ClickElement("ClickOnBulkEmail");
            JobsBulkActionsHelper.WaitForWorkAround(4000);

            //Enter Email Cc Address
            JobsBulkActionsHelper.TypeText("EnterEmailCcAddress", "");

            //Enter Email Bcc Address
            JobsBulkActionsHelper.TypeText("EnterEmailBccAddress", "");

            //Enter Email Subject
            JobsBulkActionsHelper.TypeText("EnterEmailSubject", "Job Bulkemail Testing");

            //Click On Prioroty
            JobsBulkActionsHelper.ClickElement("ClickOnPriority");

            //Click On Copy To CC Check Box
            JobsBulkActionsHelper.ClickElement("ClickOnCopyToCCCheckBox");

            //Select Copy To CC
            JobsBulkActionsHelper.Select("SelectCopyToCC", "owners");

            //Click On Copy To BCC Check Box
            JobsBulkActionsHelper.ClickElement("ClickOnCopyToBCCCheckBox");

            //Select Copy To BCC
            JobsBulkActionsHelper.Select("SelectCopyToBCC", "Managers");

            //Select Email Signature
            //JobsBulkActionsHelper.Select("SelectEmailSignature", "");

            //Click On Send Button
            JobsBulkActionsHelper.ClickElement("ClickOnSendButton");
            JobsBulkActionsHelper.WaitForWorkAround(10000);

            //Verify Page title
            VerifyTitle("Bulk E-Mails");
