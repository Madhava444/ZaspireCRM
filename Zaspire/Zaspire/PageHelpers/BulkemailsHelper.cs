...
{
    public class BulkEmailsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public BulkEmailsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("Bulkemails.xml");
        }
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//button[@data-hover='dropdown']"));
