...
{
    public class LeadsCustomViewActionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public LeadsCustomViewActionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("LeadsCustomViewActions.xml");
        }
