...
{
    [TestClass]
    public class AddNewTeam : DriverTestCase
    {
        [TestMethod]
        public void addnewTeam()
        {
            ...
            //Click on add new
            AdminTeamsHelper.ClickElement("TeamAddNew");

            //enter name
            AdminTeamsHelper.TypeText("Name", Name);

            //Select  department
            AdminTeamsHelper.Select("Department", "31");

            //Click on save button
            AdminTeamsHelper.ClickElement("SaveTeam");

            //Click on Cancel Button
            //AdminTeamsHelper.ClickElement("CancelTeam");
