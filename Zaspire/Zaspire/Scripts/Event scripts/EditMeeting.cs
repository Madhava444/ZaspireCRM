...
namespace Zaspire.Scripts
{
    ...
    public class EditMeeting: DriverTestCase
    {
        ...
        public void Editeventmeeting()
        {
            ...
            EventHelper.TypeText("EnterEventLocation", "Test23 City");

            //Enter Event Start Date
            EventHelper.TypeText("SelectEventStartDate", "2016-01-24");
            ...
            //enter on Utility
            EventHelper.TypeText("RepeteUtility", "2016-01-23");

            //click onchecbox of weekdays
            EventHelper.ClickElement("CheckboxThursday");
