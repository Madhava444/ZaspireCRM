...
namespace Zaspire.Scripts.Mainsite
{
        ...
        [TestClass]
        public class AccountsDefaultView : DriverTestCase
        {
            [TestMethod]
            public void accountsdefaultview()
            {
                ...
                AddAccountHelper.ClickElement("DefaultView");
                AddAccountHelper.WaitForWorkAround(4000);

                AddAccountHelper.ClickElement("AllAccount");
                AddAccountHelper.WaitForWorkAround(4000);
