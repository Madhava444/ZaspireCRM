...
{
    [TestClass]
    public class BulkaddGroupcampaign : DriverTestCase
    {
        [TestMethod]
        public void Addcampaign()
        {
            ...
            //Select Groupfrom dropdown
            //addcampaignHelper.Select("BulkUpdateGroup", "7");

            //Select Category
            addcampaignHelper.TypeText("GroupName", "New1");

            //Select Type
            addcampaignHelper.ClickElement("updategroup");
