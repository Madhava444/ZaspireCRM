...
{
    [TestClass]
 public class MoreActionsTask : DriverTestCase
        {
            [TestMethod]
            public void moreactionstask()
            {
                ...
                AccountsMoreActionsHelper.ClickElement("Task");

                AccountsMoreActionsHelper.TypeText("Location", "Ohio");

                AccountsMoreActionsHelper.TypeText("EnterSubject", "New Task");
