...
{
    [TestClass]
    public class View_Page_TimeLine : DriverTestCase
    {
        [TestMethod]
        public void View_Page_TimeLinewpage()
        {
           ...
           // AddAccountHelper.ClickElement("ClickTimeLine");
            ...
            AddAccountHelper.ClickElement("ClickListView");

            AddAccountHelper.ClickElement("ClickGraphicalView");
