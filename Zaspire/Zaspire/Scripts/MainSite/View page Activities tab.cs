...
{
    [TestClass]
    public class View_page_Activities_tab : DriverTestCase
    {
        [TestMethod]
        public void ViewpageActivitiestab()
        {
            ...
            AddAccountHelper.TypeText("EnterSearch", "Files");

            AddAccountHelper.ClickElement("ClickOnFile");

            AddAccountHelper.ClickElement("ViewFile");
