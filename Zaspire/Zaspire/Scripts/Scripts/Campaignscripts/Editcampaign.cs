...
namespace Zaspire.Scripts
{
    ...
    public class Editcampaign : DriverTestCase
    {
        ...
        public void EditCampaign()
        {
            ...
            //Enter Estimatedcost
            addcampaignHelper.TypeText("Expectedcost", "1500");

            //Enter Targetednum
            addcampaignHelper.TypeText("Targetednum", "150");

            //Enter Actualcost
            addcampaignHelper.TypeText("Actualcost", "200");

            //Enter Expectedresponse
            addcampaignHelper.TypeText("Expectedresponse", "300");
