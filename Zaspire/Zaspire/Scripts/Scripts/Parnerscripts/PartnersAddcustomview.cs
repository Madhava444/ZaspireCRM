...
namespace Zaspire.Scripts
{
    ...
    public class AddCustomviewParntners : DriverTestCase
    {
        ...
        public void AddcustomviewPartner()
        {
            ...
            //Select dropdown list
            addpartnerHelper.Select("Owner", "Ranjith");

            //Select dropdown list
            addpartnerHelper.Select("Manager", "Kavitha");

            //Select dropdown list
            addpartnerHelper.Select("Createdby", "Ranjith");
            ...
            //Enter text
            addpartnerHelper.TypeText("Createdtext", "Ranjith");
