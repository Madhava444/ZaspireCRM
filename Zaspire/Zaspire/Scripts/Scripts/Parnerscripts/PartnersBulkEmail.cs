...
{
    [TestClass]
    public class PartnerBulkEmail : DriverTestCase
    {
        [TestMethod]
        public void Partnerbulkemail()
        {
            ...
            //Select manger
            addpartnerHelper.Select("Manager", "28");
            ...
            //Click on Move Hover
            addpartnerHelper.MouseHover("Locator");


            //Click on Bulk Email
            addpartnerHelper.ClickElement("ClickOnBulkEmail");
            addpartnerHelper.WaitForWorkAround(4000);

            //Enter Email Cc Address
            addpartnerHelper.TypeText("EnterEmailCcAddress", "");

            //Enter Email Bcc Address
            addpartnerHelper.TypeText("EnterEmailBccAddress", "");

            //Enter Email Subject
            addpartnerHelper.TypeText("EnterEmailSubject", "Test Email");

            //Click On Prioroty
            addpartnerHelper.ClickElement("ClickOnPriority");

            //Click On Copy To CC Check Box
            addpartnerHelper.ClickElement("ClickOnCopyToCCCheckBox");

            //Select Copy To CC
            addpartnerHelper.Select("SelectCopyToCC", "owners");

            //Click On Copy To BCC Check Box
            addpartnerHelper.ClickElement("ClickOnCopyToBCCCheckBox");

            //Select Copy To BCC
            addpartnerHelper.Select("SelectCopyToBCC", "Managers");

            //Select Email Signature
            addpartnerHelper.Select("SelectEmailSignature", "");

            //Click On Send Button
            addpartnerHelper.ClickElement("ClickOnSendButton");
            addpartnerHelper.WaitForWorkAround(10000);
