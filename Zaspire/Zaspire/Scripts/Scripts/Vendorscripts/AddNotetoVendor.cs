...
namespace Zaspire.Scripts
{
    ...
    public class AddNotetoVendor : DriverTestCase
    {
        ...
        public void NotetoVendor()
        {
            ...
            //Click on Add Note
            VendorHelper.ClickElement("VendorNote");

            //Enter Note Subject
            VendorHelper.TypeText("NoteSubject", "Note for Subject");

            //Enter Note Description
            VendorHelper.TypeText("NoteDescription", "This is Note Description");
            ...
            //Click On Save
            VendorHelper.ClickElement("NoteSave");
