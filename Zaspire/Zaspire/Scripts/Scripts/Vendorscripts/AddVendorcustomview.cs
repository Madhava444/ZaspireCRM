...
namespace Zaspire.Scripts
{
    ...
    public class AddCustomviewVendorss : DriverTestCase
    {
        ...
        public void AddcustomviewVendors()
        {
            ...
            //Select dropdown list
            VendorHelper.Select("Owner1", "Ranjith");

            //Select dropdown list
            VendorHelper.Select("Manager1", "Kavitha");

            //Select dropdown list
            VendorHelper.Select("Createdby", "Ranjith");
            ...
            //Enter text
            VendorHelper.TypeText("Createdtext", "Ranjith");
            ...
            //Click on save
            VendorHelper.ClickElement("CustomSave");
