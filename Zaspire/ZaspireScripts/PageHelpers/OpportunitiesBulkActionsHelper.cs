...
{
    public class OpportunitiesBulkActionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunitiesBulkActionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunitiesBulkActions.xml");
        }
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='opportunities_grid_wrapper']/div[1]/div/div/button"));
