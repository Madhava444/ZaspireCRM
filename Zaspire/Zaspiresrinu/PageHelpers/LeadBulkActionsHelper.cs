...
{
    public class LeadBulkActionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public LeadBulkActionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("LeadBulkActions.xml");
        }
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='leads_grid_wrapper']/div[1]/div/div/button"));
