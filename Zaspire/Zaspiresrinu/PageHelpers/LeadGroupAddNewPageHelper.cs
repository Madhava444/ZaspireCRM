...
{
    public class LeadGroupAddNewPageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public LeadGroupAddNewPageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("LeadGroupAddNewPage.xml");
        }
