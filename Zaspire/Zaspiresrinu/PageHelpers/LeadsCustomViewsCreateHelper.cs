...
{
    public class LeadsCustomViewsCreateHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public LeadsCustomViewsCreateHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("LeadsCustomViewsCreate.xml");
        }
