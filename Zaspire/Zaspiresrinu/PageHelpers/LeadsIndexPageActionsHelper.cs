...
{
    public class LeadsIndexPageActionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public LeadsIndexPageActionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("LeadsIndexPageActions.xml");
        }
