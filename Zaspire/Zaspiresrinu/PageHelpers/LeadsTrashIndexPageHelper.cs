...
{
    public class LeadsTrashIndexPageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public LeadsTrashIndexPageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("LeadsTrashIndexPage.xml");
        }
