...
{
    public class LeadsTrashViewPageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public LeadsTrashViewPageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("LeadsTrashViewPage.xml");
        }
