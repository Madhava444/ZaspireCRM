...
{
    [TestClass]
    public class LeadsBulkAddToCampaign : DriverTestCase
    {
        [TestMethod]
        public void leadsbulkaddtocampaign()
        {
...
//###################  LEADS ADD TO CAMPAIGN   #########################
            ...
            //Click on Bulk Update
            LeadBulkActionsHelper.ClickElement("ClickOnAddToCampaign");
            LeadBulkActionsHelper.WaitForWorkAround(4000);

            //Click on Merge Button
            LeadBulkActionsHelper.ClickElement("ClickOnMergeButton");

            //Click On Campaign Name
            LeadBulkActionsHelper.ClickElement("ClickOnCampaignName");

            //Select Campaign Group
            //LeadBulkActionsHelper.Select("SelectCampaignGroup", "10");

            //Enter Add New Campaign Group Name
            LeadBulkActionsHelper.TypeText("EnterCampaignGroupName", "Test Group");

            //Click On Add Leads
            LeadBulkActionsHelper.ClickElement("ClickOnAddLeads");
