...
{
    public class AccessProfilesIndexHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public AccessProfilesIndexHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("AccessProfilesIndex.xml");
        }
