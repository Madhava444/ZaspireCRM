...
{
    public class EmployeesCustomViewsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public EmployeesCustomViewsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("EmployeesCustomViews.xml");
        }
