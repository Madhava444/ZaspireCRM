...
{
    public class LeadsJobPositionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public LeadsJobPositionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("LeadsJobPositions.xml");
        }
