...
{
    public class NotesIndexHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public NotesIndexHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("NotesIndex.xml");
        }
        ...
        public void MouseOver2(string locator2)
        {
