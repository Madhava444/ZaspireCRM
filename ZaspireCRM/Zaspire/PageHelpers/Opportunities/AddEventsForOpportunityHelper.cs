...
{
    public class AddEventsForOpportunityHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public AddEventsForOpportunityHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("AddEventsForOpportunity.xml");
        }
