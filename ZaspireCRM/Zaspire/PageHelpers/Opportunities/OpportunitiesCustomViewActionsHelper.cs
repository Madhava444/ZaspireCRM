...
{
    public class OpportunitiesCustomViewActionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunitiesCustomViewActionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunitiesCustomViewActions.xml");
        }
