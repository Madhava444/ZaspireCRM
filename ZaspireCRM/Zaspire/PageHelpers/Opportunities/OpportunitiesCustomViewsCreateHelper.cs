...
{
    public class OpportunitiesCustomViewsCreateHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunitiesCustomViewsCreateHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunitiesCustomViewsCreate.xml");
        }
