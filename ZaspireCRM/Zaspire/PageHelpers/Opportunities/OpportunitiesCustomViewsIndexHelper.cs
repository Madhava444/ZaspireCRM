...
{
    public class OpportunitiesCustomViewsIndexHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunitiesCustomViewsIndexHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunitiesCustomViewsIndex.xml");
        }
