...
{
    public class OpportunitiesGroupCreateHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunitiesGroupCreateHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunitiesGroupCreate.xml");
        }
