...
{
    public class OpportunitiesGroupIndexHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunitiesGroupIndexHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunitiesGroupIndex.xml");
        }
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='opportunity_groups_wrapper']/div[1]/div/div/button"));
        ...
        {
            var el = GetWebDriver().FindElement(ByLocator("//*[@id='opportunity_groups']/tbody/tr[1]/td[2]/a"));
