...
{
    public class OpportunitiesGroupTrashIndexHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunitiesGroupTrashIndexHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunitiesGroupTrashIndex.xml");
        }
