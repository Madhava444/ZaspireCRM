...
{
    public class OpportunitiesImportsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunitiesImportsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunitiesImports.xml");
        }
