...
{
    public class OpportunitiesIndexHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunitiesIndexHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunitiesIndex.xml");
        }
