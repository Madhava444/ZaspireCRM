...
{
    public class OpportunitiesTrashIndexPageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunitiesTrashIndexPageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunitiesTrashIndexPage.xml");
        }
