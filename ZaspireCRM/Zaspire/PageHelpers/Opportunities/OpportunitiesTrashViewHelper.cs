...
{
    public class OpportunitiesTrashViewHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunitiesTrashViewHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunitiesTrashView.xml");
        }
