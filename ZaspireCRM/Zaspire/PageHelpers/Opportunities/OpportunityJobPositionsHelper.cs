...
{
    public class OpportunityJobPositionsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunityJobPositionsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunityJobPositions.xml");
        }
