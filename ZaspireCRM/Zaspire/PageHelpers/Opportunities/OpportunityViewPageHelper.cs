...
{
    public class OpportunityViewPageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OpportunityViewPageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OpportunityViewPage.xml");
        }
