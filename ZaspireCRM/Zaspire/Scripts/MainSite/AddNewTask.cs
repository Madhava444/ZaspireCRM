...
{
    [TestClass]
    public class AddNewTask : DriverTestCase
    {
        [TestMethod]
        public void addnewtask()
        {
            ...
            var EventSubject = "Test Task" + RandomNumber(1, 99);
            ...
            //Select Event Type
            AddNewEventHelper.Select("SelectEventType", "Task");
            ...
            AddNewEventHelper.TypeText("SelectEventStartDate", "2015-12-07");
            ...
            AddNewEventHelper.TypeText("SelectEventDueDate", "2015-12-08");
