...
{
    [TestClass]
    public class EmployeeUpdate : DriverTestCase
    {
        [TestMethod]
...
//#################### EMPLOYEE DETAILS  #####################################
            ...
            //Enter Phone Number
            AddNewEmployeeHelper.TypeText("EnterPhoneNumber", "9856321475");
...
//############################# EMPLOYEE ADDRESS   #################################
            ...
            //Enter Address Line1
            AddNewEmployeeHelper.TypeText("EnterAddressLine1", "Test Addressline11");

            //Enter Address Line2
            AddNewEmployeeHelper.TypeText("EnterAddressLine2", "Test Addressline21");

            //Enter City
            AddNewEmployeeHelper.TypeText("EnterCity", "Test City1");
            ...
            //Enter Zip Code
            AddNewEmployeeHelper.TypeText("EnterZipCode", "98547");
