...
{
    [TestClass]
    public class EmployeeUserUpdate : DriverTestCase
    {
        [TestMethod]
        public void employeeuserupdate()
        {
...
//######################  USER DETAILS  ###########################
            ...
            AddNewEmployeeHelper.WaitForWorkAround(5000);
...
//######################  EMPLOYEE USER UPDATE  ###########################
            ...
            AddNewEmployeeHelper.TypeText("EnterFilterSearchBox", FirstName);
            AddNewEmployeeHelper.WaitForWorkAround(10000);

            //Click on Edit
            AddNewEmployeeHelper.ClickElement("ClickOnEdit");
...
//#################### EMPLOYEE DETAILS  #####################################
            ...
            //Enter Contact Email
            AddNewEmployeeHelper.TypeText("EnterContactEmail", "srinivas.ganagoni@infozeal.com");

            //Select Phone Type
            AddNewEmployeeHelper.Select("SelectPhoneType", "Home");

            //Enter Phone Number
            AddNewEmployeeHelper.TypeText("EnterPhoneNumber", "4586932175");
            ...
            //Enter Address Line1
            AddNewEmployeeHelper.TypeText("EnterAddressLine1", "Test Addressline19");

            //Enter Address Line2
            AddNewEmployeeHelper.TypeText("EnterAddressLine2", "Test Addressline29");

            //Enter City
            AddNewEmployeeHelper.TypeText("EnterCity", "Test City9");

            //Select State
            AddNewEmployeeHelper.Select("SelectState", "OR");
            ...
            //Enter Zip Code
            AddNewEmployeeHelper.TypeText("EnterZipCode", "96325");
...
//######################  UPDATE EMPLOYEE USER  ###########################
            ...
            //Click on Save
            AddNewEmployeeHelper.ClickElement("ClickOnEditSave");
            AddNewEmployeeHelper.WaitForWorkAround(10000);
