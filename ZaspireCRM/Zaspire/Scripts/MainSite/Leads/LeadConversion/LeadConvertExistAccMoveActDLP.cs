...
{
    [TestClass]
    public class LeadConvertExistAccMoveActDLP : DriverTestCase
    {
        [TestMethod]
        public void leadconvertexistaccmoveactdlp()
        {
...
//######################  LEAD CONVERSION  ###########################
            ...
            LeadConversionHelper.ClickElement("SelectExistAccount");
            LeadConversionHelper.WaitForWorkAround(5000);

            //Click On Merge Button
            LeadConversionHelper.ClickElement("ClickOnMergeButton");

            //Click On Record
            LeadConversionHelper.ClickElement("ClickOnRecord");

            //Check New Opportunity
            LeadConversionHelper.ClickElement("CheckNewOpportunity");

            //Select Move Activity
            LeadConversionHelper.ClickElement("SelectMoveActivity");
            ...
            //Select Delete the Lead Permanently
            LeadConversionHelper.ClickElement("SelectDeleteLeadPermanently");
