...
{
    [TestClass]
    public class LeadsBulkAddToGroup : DriverTestCase
    {
        [TestMethod]
        public void leadsbulkaddtogroup()
        {
...
//###################  LEADS ADD TO GROUP   #########################
            ...
            LeadBulkActionsHelper.ClickElement("ClickOnAddToGroup");
            LeadBulkActionsHelper.WaitForWorkAround(4000);

            
            //Select Lead Group
            //LeadBulkActionsHelper.Select("SelectLeadGroup", "10");

            //Enter Add New Lead Group Name
            LeadBulkActionsHelper.TypeText("EnterLaedGroupName", "Test Group");

            //Click On Add Leads
            LeadBulkActionsHelper.ClickElement("ClickOnAddGroupUpdate");
