...
{
    [TestClass]
    public class LeadsBulkEmail : DriverTestCase
    {
        [TestMethod]
        public void leadsbulkemail()
        {
...
//###################  LEADS BULK EMAIL   #########################
            ...
            //Click on Search Lead Company Name
            ...
            //Click on Bulk Email
            LeadBulkActionsHelper.ClickElement("ClickOnBulkEmail");
            LeadBulkActionsHelper.WaitForWorkAround(4000);

            //Enter Email Cc Address
            LeadBulkActionsHelper.TypeText("EnterEmailCcAddress", "");

            //Enter Email Bcc Address
            LeadBulkActionsHelper.TypeText("EnterEmailBccAddress", "");

            //Enter Email Subject
            LeadBulkActionsHelper.TypeText("EnterEmailSubject", "Test Email");

            //Click On Prioroty
            LeadBulkActionsHelper.ClickElement("ClickOnPriority");

            //Click On Copy To CC Check Box
            LeadBulkActionsHelper.ClickElement("ClickOnCopyToCCCheckBox");

            //Select Copy To CC
            LeadBulkActionsHelper.Select("SelectCopyToCC", "owners");

            //Click On Copy To BCC Check Box
            LeadBulkActionsHelper.ClickElement("ClickOnCopyToBCCCheckBox");

            //Select Copy To BCC
            LeadBulkActionsHelper.Select("SelectCopyToBCC", "Managers");

            //Select Email Signature
            LeadBulkActionsHelper.Select("SelectEmailSignature", "");

            //Click On Send Button
            LeadBulkActionsHelper.ClickElement("ClickOnSendButton");
            LeadBulkActionsHelper.WaitForWorkAround(10000);
