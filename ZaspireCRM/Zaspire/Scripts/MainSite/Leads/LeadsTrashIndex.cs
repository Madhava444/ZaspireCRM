...
{
    [TestClass]
    public class LeadsTrashIndex : DriverTestCase
    {
        [TestMethod]
        public void leadstrashindex()
        {
            ...
            LeadsTrashIndexPageHelper.ClickElement("ClickOnGroupTrashBack");
            ...
            //Click On Back To LeadsTrash
            LeadsTrashIndexPageHelper.ClickElement("ClickOnLeadViewBack");
