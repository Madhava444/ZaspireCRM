...
{
    [TestClass]
    public class LeadsCustomViewsUpdate : DriverTestCase
    {
        [TestMethod]
        public void leadscustomviewsupdate()
        {
            ...
            //Click on Edit Custom View
            LeadsCustomViewsCreateHelper.ClickElement("ClickOnEdit");
