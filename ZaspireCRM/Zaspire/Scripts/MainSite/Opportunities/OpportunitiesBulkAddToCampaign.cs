...
{
    [TestClass]
    public class OpportunitiesBulkAddToCampaign : DriverTestCase
    {
        [TestMethod]
        public void opportunitiesbulkaddtocampaign()
        {
...
//###################  OPPORTUNITIES ADD TO CAMPAIGN   #########################
            ...
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnAddToCampaign");
            OpportunitiesBulkActionsHelper.WaitForWorkAround(4000);

            //Click on Merge Button
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnMergeButton");

            //Click On Campaign Name
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnCampaignName");

            //Select Campaign Group
            //OpportunitiesBulkActionsHelper.Select("SelectCampaignGroup", "10");

            //Enter Add New Campaign Group Name
            OpportunitiesBulkActionsHelper.TypeText("EnterCampaignGroupName", "Test Group");

            //Click On Add Opportunities
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnAddOpportunities");
