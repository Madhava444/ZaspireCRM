...
{
    [TestClass]
    public class OpportunitiesBulkDelete : DriverTestCase
    {
        [TestMethod]
        public void opportunitiesbulkdelete()
        {
...
//###################  OPPORTUNITIES BULK DELETE  #########################
            ...
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnDeleteOpportunities");
