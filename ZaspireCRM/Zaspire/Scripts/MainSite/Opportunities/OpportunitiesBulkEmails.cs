...
{
    [TestClass]
    public class OpportunitiesBulkEmails : DriverTestCase
    {
        [TestMethod]
        public void opportunitiesbulkemails()
        {
            ...
            var OpportunitiesBulkActionsHelper = new OpportunitiesBulkActionsHelper(GetWebDriver());
...
//################### CLASSIFICATIONS & OWNERSHIP  #########################
            ...
            //Select Category
            AddNewOpportunityHelper.Select("SelectCategory", "12524");

            //Select Owner  
            AddNewOpportunityHelper.Select("SelectOwner", "17");

            //Select Manager
            AddNewOpportunityHelper.Select("SelectManager", "17");
...
//###################  OPPORTUNITIES BULK EMAIL   #########################
            ...
            //Enter Search Opportunity name
            OpportunitiesBulkActionsHelper.TypeText("SearchOpportunityCompany", OpportunityName);
            OpportunitiesBulkActionsHelper.WaitForWorkAround(10000);

            //Click on Master Check Box
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnMasterCheckBox");

            //Click on Move over
            OpportunitiesBulkActionsHelper.MouseOver("Locator");


            //Click on Bulk Email
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnBulkEmail");
            OpportunitiesBulkActionsHelper.WaitForWorkAround(4000);

            //Enter Email Cc Address
            OpportunitiesBulkActionsHelper.TypeText("EnterEmailCcAddress", "");

            //Enter Email Bcc Address
            OpportunitiesBulkActionsHelper.TypeText("EnterEmailBccAddress", "");

            //Enter Email Subject
            OpportunitiesBulkActionsHelper.TypeText("EnterEmailSubject", "Test Email");

            //Click On Prioroty
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnPriority");

            //Click On Copy To CC Check Box
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnCopyToCCCheckBox");

            //Select Copy To CC
            OpportunitiesBulkActionsHelper.Select("SelectCopyToCC", "owners");

            //Click On Copy To BCC Check Box
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnCopyToBCCCheckBox");

            //Select Copy To BCC
            OpportunitiesBulkActionsHelper.Select("SelectCopyToBCC", "Managers");

            //Select Email Signature
            OpportunitiesBulkActionsHelper.Select("SelectEmailSignature", "");

            //Click On Send Button
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnSendButton");
            OpportunitiesBulkActionsHelper.WaitForWorkAround(10000);
