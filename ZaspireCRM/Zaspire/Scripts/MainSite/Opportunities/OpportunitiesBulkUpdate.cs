...
{
    [TestClass]
    public class OpportunitiesBulkUpdate : DriverTestCase
    {
        [TestMethod]
        public void opportunitiesbulkupdate()
        {
...
//################### OPPORTUNITIES BULK UPDATE  #########################
            ...
            //Search Opportunity Company Name
            ...
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnBulkUpdate");
            OpportunitiesBulkActionsHelper.WaitForWorkAround(4000);

            //Select Status
            OpportunitiesBulkActionsHelper.Select("SelectStatus", "Prospecting");

            //Select Source
            OpportunitiesBulkActionsHelper.Select("SelectSource", "Email");

            //Select Category
            OpportunitiesBulkActionsHelper.Select("SelectCategory", "12525");

            //Select Owner
            OpportunitiesBulkActionsHelper.Select("SelectOwner", "20");

            //Select Manager
            OpportunitiesBulkActionsHelper.Select("SelectManager", "20");

            //Click on Update
            OpportunitiesBulkActionsHelper.ClickElement("ClickOnUpdate");
            OpportunitiesBulkActionsHelper.WaitForWorkAround(4000);

            OpportunitiesBulkActionsHelper.AcceptAlert();
            OpportunitiesBulkActionsHelper.WaitForWorkAround(10000);
