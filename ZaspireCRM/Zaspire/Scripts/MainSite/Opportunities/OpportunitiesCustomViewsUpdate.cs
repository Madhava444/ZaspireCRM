...
{
    [TestClass]
    public class OpportunitiesCustomViewsUpdate : DriverTestCase
    {
        [TestMethod]
        public void opportunitiescustomviewsupdate()
        {
            ...
            //Click on Edit
            OpportunitiesCustomViewsCreateHelper.ClickElement("ClickOnEdit");
