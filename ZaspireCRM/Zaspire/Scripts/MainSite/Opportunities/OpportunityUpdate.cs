...
{
    [TestClass]
    public class OpportunityUpdate : DriverTestCase
    {
        [TestMethod]
        public void opportunityupdate()
        {
...
//#################### UPDATE OPPORTUNITY   #####################################
            ...
            AddNewOpportunityHelper.MouseOver("locator");
            AddNewOpportunityHelper.WaitForWorkAround(5000);

            //Clock On Quick Look
            AddNewOpportunityHelper.ClickElement("ClockOnQuickLook");
            AddNewOpportunityHelper.WaitForWorkAround(5000);

            //Clock On Quick Look Edit
            AddNewOpportunityHelper.ClickElement("ClockOnQuickLookEdit");
